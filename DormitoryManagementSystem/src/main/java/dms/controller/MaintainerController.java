...
public class MaintainerController {
    ...
    @RequestMapping("/addMaintainer")
    public String add(Maintainer maintainer) {
    	maintainerService.saveAll(maintainer);
    	return "redirect:/superAdmin/showPageMaintainer";
    }
	//批量删除
	@RequestMapping("/deleteMaintainer")
	public String delete(@RequestParam("id") String id){
	    ...
	    maintainerService.deleteBatch(LString);
	    return "redirect:/superAdmin/showPageMaintainer";
	}
	//修改
	@RequestMapping("/editMaintainer")
	public String edit(Maintainer maintainer) {
		maintainerService.edit(maintainer);
		return "redirect:/superAdmin/showPageMaintainer";
	}
	
	// 分页查询
	@RequestMapping("/showPageMaintainer")
	public String showPageMaintainer(Model model, @RequestParam(value = "page", defaultValue = "1") int page,
		...
		Page<Maintainer> articleDatas = maintainerService.findAll(pageable);
		...
		// 查询出的结果数据集合
		List<Maintainer> articles = articleDatas.getContent();
		...
		model.addAttribute("temp", page);
     	return "superAdmin/maintainerInfo";
	}
	@RequestMapping("/getMaintainerInfo")
	@ResponseBody
	public List<Map<String, Object>> getMaintainerInfo() {
		return maintainerService.getMaintainerInfo();
	}
